...
public class FluidBlocks {
    ...
    public static final Block Molten_Obsidian_Magic = new ClassicCreator(Fluids.Obsidian_Magic);
    public static final Block Molten_Iridium = new ClassicCreator(Fluids.Iridium);
